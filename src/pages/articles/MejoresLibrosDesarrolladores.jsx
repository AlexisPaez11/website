  ...
  return (
    <section className='article-section'>
      <div className="article-container">
        ...
        <h2>Aprendiendo GIT <span>· Miguel Ángel Durán</span></h2>
        ...
        <h2>The Pragmatic Programmer <span>· Andrew Hunt y David Thomas</span></h2>
        ...
        <h2>Introduction to Algorithms <span>· Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest y Clifford Stein.</span></h2>
        ...
        <h2>Clean Code <span>· Robert C. Martin</span></h2>
        ...
        <h2>The Clean Coder <span>· Robert C. Martin</span></h2>
        ...
        <h2>El gran libro de HTML5, CSS3 y JavaScript <span>· Juan Diego Gauchat</span></h2>
